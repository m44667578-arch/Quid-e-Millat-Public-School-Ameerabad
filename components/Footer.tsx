      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mt-2 text-gray-300 text-sm">Ameerabad, [City, Postal Code]</p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-sm text-gray-300">Email: info@qmpameerabad.edu</li>
              <li className="text-sm text-gray-300">Phone: +91-123-456-7890</li>
            </ul>
          </div>
        </div>
