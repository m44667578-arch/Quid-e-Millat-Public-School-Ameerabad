...
const Home: React.FC<HomeProps> = ({ studentCount, staffCount, openAuthModal, registrationMessage, leadershipMessages }) => {
  return (
    <div className="bg-school-light">
      {/* Hero Section */}
      <div className="relative bg-school-blue h-96">
        <img src="https://picsum.photos/1600/600?grayscale&blur=2" alt="School Campus" className="w-full h-full object-cover opacity-30" />
